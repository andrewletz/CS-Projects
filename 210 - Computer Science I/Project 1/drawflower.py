...
def draw_flower(my_turtle, num_squares, side_length):
    ...
    for i in range(num_squares):    # for the amount of squares the user specified
        turn_radius = 360 / num_squares    # amount to turn the turtle based on no. of squares
        my_turtle.right(turn_radius)    # turn the turtle
        draw_square(my_turtle, side_length)    # draw a square at that angle
