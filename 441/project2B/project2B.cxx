...
class vtk441MapperPart3 : public vtk441Mapper {
	...
	void DrawMouth(void) {
		glPushMatrix();
		LightBrown();
		glScalef(0.35, 0.5, 0.14);
		DrawSphere(); // draw upper mouth

		glPushMatrix(); // draw nose
		Black();
		glTranslatef(0.95, 0, 0.22);
		glScalef(0.15, 0.25, 0.85);
		DrawSphere();
		glPopMatrix();

		glPushMatrix(); // draw tongue
		Pink();
		glTranslatef(0.95, 0, -0.44);
		glScalef(0.8, 0.33, 0.15);
		DrawSphere();
		glPopMatrix();
	...
	void DrawEar(void) {
		glPushMatrix();
		DarkBrown();
		glScalef(0.8, 0.25, 1.2);
		DrawSphere();
		glPopMatrix();
	}

	void DrawLegWithFoot(void) {
		glPushMatrix();
		DarkBrown();
		glScalef(0.8, 0.8, 8.0);
		DrawCylinder();
		glPopMatrix();
	...
	virtual void RenderPiece(vtkRenderer *ren, vtkActor *act) {
		...
		// draw mouth
		glPushMatrix();
		glTranslatef(mag*cos(angleRadians) + 0.1, 0.0, -0.1);
		DrawMouth();
		glPopMatrix();

		// draw ears
		glPushMatrix();
		glTranslatef(0, -0.95, -0.85);
		DrawEar();
		glPopMatrix();
		...
		glPopMatrix(); // done with head and eyeballs
		...
		glScalef(2.5, 1.8, 2.4);
		DrawSphere();
		glPopMatrix();

		// draw legs
		glPushMatrix();
		glTranslatef(-4, 2, -15.5);
		DrawLegWithFoot();
		glPopMatrix();
...
int main() {
	...
	ren3->GetActiveCamera()->SetPosition(0,0,60);
