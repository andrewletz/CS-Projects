...
class vtk441Mapper : public vtkOpenGLPolyDataMapper {
	...
	public:
		vtk441Mapper() { initialized = false; }
...
class vtk441MapperPart1 : public vtk441Mapper {
 public:
	...
	virtual void RenderPiece(vtkRenderer *ren, vtkActor *act) {
		...
		for (Triangle t : tris) {
			unsigned char color1 = colorMap[(int) (t.fieldValue[0] * 255) * 3];
			unsigned char color2 = colorMap[(int) (t.fieldValue[1] * 255) * 3 + 1];
			unsigned char color3 = colorMap[(int) (t.fieldValue[2] * 255) * 3 + 2];
